...
const AdminPromotionEdit = () => {
    ...
    const { getPromotionById, updatePromotion } = usePromotions();
    const { products } = useProducts();
    const navigate = useNavigate();
    const promotion = id ? getPromotionById(id) : undefined;
    ...
    useEffect(() => {
        if (promotion) {
            setForm({
                ...
                discountPercentage: promotion.discountPercentage === 0 ? '' : String(promotion.discountPercentage),
    ...
    return (
        <div className="min-h-screen bg-hotwheel-gray-25">
            <div className="container mx-auto px-4 section-padding">
                <h1 className="text-3xl font-bold text-corporate mb-8">Editar Promoção</h1>
